...
<div class="container mt-5">
    <div class="card p-4 shadow">
        <h2 class="text-center text-success">Add Event</h2>

        <form action="InsertEvent" method="post">
            <input class="form-control mb-2" type="text" name="id" placeholder="Event ID">
            <input class="form-control mb-2" type="text" name="name" placeholder="Event Name">
        <input type="date" name="date" class="form-control mb-2" required>
            <input class="form-control mb-2" type="text" name="location" placeholder="Location">
